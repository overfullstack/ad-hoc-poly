 ...
 */
private fun <F> RuleRunnerStrategy<F, ValidationError>.contains(email: String, needle: String) =
 ...
 * Arbitrary rules can be defined anywhere outside the Rules algebra.
 */
private fun <F> RuleRunnerStrategy<F, ValidationError>.maxLength(email: String, maxLength: Int) =
 ...
 */
fun <F> RuleRunnerStrategy<F, ValidationError>.emailRuleRunner(email: String) =
        mapN(
                contains(email, "@"),
                maxLength(email, 250)
        ) {
